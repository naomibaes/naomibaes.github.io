...
sections:
  ...
  - block: markdown
    content:
      ...
      subtitle: ''
      text: |-
        My research investigates how concepts change meaning over time, with a focus on the mental health domain. With my PhD supervisors, I have developed a novel framework, **SIBling**, to model and measure lexical semantic change (LSC) along three dimensions that are mostly overlooked by existing approaches, which treat semantic change as unitary phenomenon.
