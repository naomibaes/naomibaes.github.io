...
[Naomi Baes](https://findanexpert.unimelb.edu.au/profile/855406-naomi-baes) is a doctoral researcher at the intersection of **Psychology** and **Natural Language Processing**, focused on modelling conceptual change in socially salient mental health concepts using language models and historical corpora. She is a recipient of the highly competitive *Australian Government Research Training Program Scholarship* and is supervised by [Professor Nick Haslam](https://findanexpert.unimelb.edu.au/profile/6837-nicholas-haslam) and [Dr Ekaterina Vylomova](http://kat.academy/). Co-designed **SIBling**, a multidimensional framework capturing semantic change across its major dimensions (*Sentiment*, *Intensity*, and *Breadth*), with unique applications across the social sciences. Led the development of **LSC-Eval**, a benchmarking framework using LLM-generated synthetic corpora to evaluate the validity of semantic change methods in controlled experiments. Applies these methods to historical psychology, media, and everyday discourse to reveal the social and cultural dynamics behind language change. Work accepted at leading international venues **ACL 2024** (main conference), **IC2S2 2025** (forthcoming), and **EMNLP (LChange’23)**. Contributor to the organisation of shared NLP tasks like **SemEval-2025** (multilingual emotion recognition) and **SemEval-2026** (semantic sense relations; hopefully forthcoming).

<ul>
  <li><strong>Co-designed SIBling</strong>, a multidimensional framework capturing semantic change across its major dimensions (<em>Sentiment</em>, <em>Intensity</em>, and <em>Breadth</em>), with unique applications across the social sciences.</li>
  <li><strong>Led the development of LSC-Eval</strong>, a benchmarking framework that generates LLM-based synthetic corpora to evaluate the validity of semantic change methods in controlled experiments.</li>
  <li>Applies these methods to historical psychology, media, and everyday discourse to reveal the social and cultural dynamics behind language change.</li>
  <li>Work accepted at leading international venues <strong>ACL 2024</strong> (main conference), <strong>IC2S2 2025</strong> (forthcoming), and <strong>EMNLP (LChange’23)</strong>.</li>
  <li>Contributor to shared NLP tasks including <strong>SemEval-2025</strong> and <strong>SemEval-2026</strong>.</li>
</ul>
