...
I study how concepts change their meaning over time. Using language models and historical corpora, I develop tools to model semantic change across three dimensions: Sentiment, Intensity, and Breadth (SIB). Supported by an Australian Government Research Training Program Scholarship, I pursue this work under the supervision of [Professor Nick Haslam](https://findanexpert.unimelb.edu.au/profile/6837-nicholas-haslam) and [Dr Ekaterina Vylomova](http://kat.academy/) at the University of Melbourne. Alongside **SIBling**, I co-developed **LSC-Eval** with [Dr Haim Dubossarsky](https://scholar.google.com/citations?user=2EDsENQAAAAJ&hl=en) and [Raphaël Merx](https://www.rapha.dev/), a benchmarking framework that uses LLM-generated diachronic corpora to evaluate methods for detecting semantic change. My work bridges computational linguistics, psychology, natural language processing, and social science, and has been presented at top venues including **ACL**, **IC2S2**, and **EMNLP**. I also contribute to shared tasks ([BRIGHTER](https://brighter-dataset.github.io/); [BLEnD](https://junhomyung.github.io/BLEnD/)) and serve on program committees (**[NLP4Democracy](https://sites.google.com/andrew.cmu.edu/nlp4democracy/)**; **[SEM2025](https://starsem2025.github.io/)**).