...
[Naomi Baes](https://findanexpert.unimelb.edu.au/profile/855406-naomi-baes) is a doctoral researcher at the intersection of **Psychology** and **Natural Language Processing**. Supported by an *Australian Government Research Training Program Scholarship* and supervised by [Professor Nick Haslam](https://findanexpert.unimelb.edu.au/profile/6837-nicholas-haslam) and [Dr Ekaterina Vylomova](http://kat.academy/), her core research involves **modelling conceptual change in mental health concepts** using **language models** and **historical corpora**. A key achievement is co-developing **SIBling**, a multidimensional framework for evaluating semantic change across three major dimensions (*Sentiment*, *Intensity*, and *Breadth*) and proposing scalable computational methods for its application across the social sciences. She also led the development of **LSC-Eval** (with her supervisors and collaborators [Dr Haim Dubossarsky](https://scholar.google.com/citations?user=2EDsENQAAAAJ&hl=en) and [Raphaël Merx](https://www.rapha.dev/)), a benchmarking framework that uses LLM-generated synthetic corpora to evaluate semantic change detection methods. Her research **applies** these tools to diverse corpora, including scientific, media, and everyday language, to model conceptual change and uncover its social and cultural drivers. Naomi has presented her work at leading venues including **ACL 2024**, **ACL 2025** (forthcoming), **IC2S2 2025** (forthcoming), and **EMNLP (LChange’23)**. Naomi also contributes to NLP SemEval tasks ([BRIGHTER](https://brighter-dataset.github.io/): multilingual emotion recognition) and serves on program committees for **[NLP4Democracy](https://sites.google.com/andrew.cmu.edu/nlp4democracy/)** and **[SEM2025](https://starsem2025.github.io/)**.
