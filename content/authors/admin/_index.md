...
<p>I build computational tools to measure this kind of change precisely — and to study semantic change more broadly. My frameworks, <strong>SIBling</strong> and <strong>LSC-Eval</strong>, are designed to detect and evaluate specific kinds of semantic change across domains: whether a word is broadening in scope, gaining emotional intensity, or shifting in evaluative tone. My PhD applies these tools to mental health concepts, tracing how terms like <em>schizophrenia</em> have changed their meaning across decades of historical text - and what those shifts reveal about how psychological categories are culturally constructed and contested. The methods are computational, but the questions are substantive.</p>
