...
I am a PhD candidate in Computational Social Science, working at the intersection of NLP, computational linguistics, and psychology to study how socially salient concepts change their meanings over time. Using language models and historical corpora, I co-developed the linguistic framework of **SIBling** with my supervisors [Professor Nick Haslam](https://findanexpert.unimelb.edu.au/profile/6837-nicholas-haslam) and [Dr Ekaterina Vylomova](http://kat.academy/), modeling semantic change across three dimensions — Sentiment, Intensity, and Breadth. Alongside SIBling, I co-developed **LSC-Eval** (with [Dr Haim Dubossarsky](https://scholar.google.com/citations?user=2EDsENQAAAAJ&hl=en) and [Raphaël Merx](https://www.rapha.dev/)), a benchmarking framework that uses LLM-generated diachronic corpora to evaluate methods for detecting semantic change. Together, these frameworks advance both computational methods and applications, providing new tools to trace cultural and social dynamics in domains such as mental health. My research is supported by an Australian Government Research Training Program Scholarship. I also contribute to shared tasks ([BRIGHTER](https://brighter-dataset.github.io/); [BLEnD](https://junhomyung.github.io/BLEnD/)) and serve on program committees (**[NLP4Democracy](https://sites.google.com/andrew.cmu.edu/nlp4democracy/)**; **[SEM2025](https://starsem2025.github.io/)**).