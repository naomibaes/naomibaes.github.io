...
role: PhD Candidate | Computational Social Science · Psychology · Natural Language Processing
...
I am a computational social scientist working at the intersection of psychology and natural language processing, developing theory-driven methods to study how socially meaningful concepts change over time and across domains. My research uses historical text corpora, contextual embeddings, and large language models to examine conceptual and lexical semantic change, with a focus on the changing representations of mental health-related concepts. I co-developed **SIBling**, a framework for modelling semantic change across the dimensions of Sentiment, Intensity, and Breadth, and **LSC-Eval**, a benchmarking framework for evaluating methods for detecting lexical semantic change using synthetic historical data. More broadly, I am interested in conceptual change, language change and variation, mental health discourse, and computational approaches to societally significant questions. I am active in the NLP community through workshop organisation, shared tasks, and program committee service, and in the psychology and computational social science through peer review service.
