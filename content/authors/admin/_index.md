...
[Naomi Baes](https://findanexpert.unimelb.edu.au/profile/855406-naomi-baes) is a doctoral researcher at the intersection of **Psychology** and **Natural Language Processing**, focused on modelling conceptual change in socially salient mental health concepts using language models and historical corpora. She is supported by the prestigious *Australian Government Research Training Program Scholarship* and is supervised by [Professor Nick Haslam](https://findanexpert.unimelb.edu.au/profile/6837-nicholas-haslam) and [Dr Ekaterina Vylomova](http://kat.academy/).

- Co-designed **SIBling**, a multidimensional framework capturing semantic change across *Sentiment*, *Intensity*, and *Breadth*.
- Developed **LSC-Eval**, a benchmarking framework using synthetic corpora generated by large language models to evaluate semantic change methods.
...
- Work accepted at **ACL 2024**, **IC2S2 2025**, and **EMNLP (LChange’23)**.
- Contributor to shared tasks like **SemEval-2025/2026**.
