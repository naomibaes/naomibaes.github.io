...
[Naomi Baes](https://findanexpert.unimelb.edu.au/profile/855406-naomi-baes) is a doctoral researcher at the intersection of Psychology and Natural Language Processing, focused on modelling conceptual change in socially salient mental health concepts using language models and historical corpora. She is supported by a highly competitive Australian Government Research Training Program Scholarship. Together with her supervisors, [Professor Nick Haslam](https://findanexpert.unimelb.edu.au/profile/6837-nicholas-haslam) and [Dr Ekaterina Vylomova](http://kat.academy/), she designed \textit{SIBling}, a multidimensional linguistic model that captures key dimensions of lexical semantic change—\textit{Sentiment}, \textit{Intensity}, and \textit{Breadth}, and proposed scalable commputational methods to model these dimensions and uncover their social and cultural drivers, with unique application across the social sciences. To evaluate these methods, Naomi led the development of LSC-Eval—a general benchmarking framework that generates synthetic corpora using large language models, simulating specific semantic dimensions to assess the validity of existing semantic change methods in controlled exprimental settings. Naomi applies SIBling to historical text from academic psychology, everyday vernacular and media to examine how the meanings of mental health concepts evolve, shedding light on the broader social and cultural dynamics driving this change. Her work has been presented at leading international venues, including ACL 2024, IC2S2 2025 (forthcoming), and EMNLP (LChange’23), and she contributes to shared NLP tasks such as SemEval-2025/2026.
